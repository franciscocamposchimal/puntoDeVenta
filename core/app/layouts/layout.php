            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                  <!--    <a href="" target="_blank" class="">Ir a Evilnapsis</a>
                      <a href="" target="_blank" class="">Ver Inventio Max</a> -->
                  </li>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2017 <a href="#" target="_blank">Franko</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
